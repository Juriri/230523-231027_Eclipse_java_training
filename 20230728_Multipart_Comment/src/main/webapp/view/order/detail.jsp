...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/order_style.css">
    <script type="text/javascript">
	    function populateDropdown(maxValue) {
	        var dropdown = document.getElementById("quantitySelect");
	    ...
	    window.onload = function() {
	        var productQuantity = ${product.quantity}; // Make sure this value is properly set in the JSP code
	        populateDropdown(productQuantity);
	        updatePrice(); // Call the updatePrice function initially to set the correct price.
	    };

	    document.getElementById("quantitySelect").onchange = function() {
	    	console.log("Dropdown value changed!");
		    updatePrice(); // Call the updatePrice function when the dropdown value changes
	    };
        ...
        function addComment() {
            ...
            xhr.open("POST", "${pageContext.request.contextPath}/comment/CommentController?action=add", true);
        ...
        <form name="buyForm" class="buyForm" action="${pageContext.request.contextPath}/seller/Edit" method="post">
            <table>
                ...
                <tr>
                    <th>주문수량</th>
                    <td>
                        <select id="quantitySelect" name="quantity"></select>
                    </td>
                </tr>
                <tr>
                    <th>가격</th>
                    <td>
                        <input type="text" id="priceInput" name="price" value="${product.price}" readonly>
                    </td>
                </tr>
                <tr>
                    <th>상품 이미지</th>
