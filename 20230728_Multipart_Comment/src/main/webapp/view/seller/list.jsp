...
<body>
	...
	<a href="${pageContext.request.contextPath}/view/seller/addForm.jsp">새 상품 등록</a><br>
	<br>
	<c:choose>
	    ...
	    <c:otherwise>
			<table border="1">
				...
				<tr>
					<td>
					<a href="${pageContext.request.contextPath }/seller/detail?num=${product.getNum()}&type=seller">${product.getNum()}</a>
					</td>
					...
					<td>
						<form action="${pageContext.request.contextPath}/seller/Del?num=${product.getNum()}" method="post">
							<input type="submit" name="delete" value="삭제">
						</form>
						<form action="${pageContext.request.contextPath}/seller/detail?num=${product.getNum()}&type=seller" method="post">
